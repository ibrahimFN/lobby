...
(async () => {
	...
	bot.on('message', message => {
		...
		if (command === 'skin' || command === 'outfit') {
			...
			embed.setThumbnail('https://blobry.herokuapp.com/images/cosmetics/br/CID_030_Athena_Commando_M_Halloween/icon.png');
			message.channel.send(embed);
		}
			...
			embed.setThumbnail('https://blobry.herokuapp.com/images/cosmetics/br/CID_029_Athena_Commando_F_Halloween/icon.png');
			message.channel.send(embed);
		}
